...
return [
    ...
    'header_exclusion' => 'EXCLUSION AND CONSENT PLEASE READ THIS DOCUMENT CAREFULLY.',
...
I, the individual listed below, hereby represent and warrant to PT DUE that I have reached the minimum age of 18 years, and accept and agree to this Exclusion and Consent on my own behalf and/or on behalf of the participant listed below who is under 18 years old ("Minor") as their authorized representative or as the parent or legal guardian (as the case may be) acting on their behalf.

With respect to the listed Minor (if any), I declare that I have full authority as, or on behalf of, the parent or legal guardian of the Minor to consent to the terms of this Exclusion and Consent for and on their behalf.
...
II. any negligent or more culpable acts or omissions (including any reckless or intentional misconduct) committed by me or any Minor under my care, including but not limited to my failure to provide care and supervision for the Minor;
...
Any provision deemed invalid, unenforceable, or void will only be ineffective to the extent of such invalidity, unenforceability, or voidness, without affecting the other provisions herein, which will remain in full force and effect. The provision will be modified as necessary to best reflect the original intent and purpose while making it valid and enforceable.

I, on my own behalf and/or as the parent, legal guardian, or custodian of the registered minor(s) (or as their legal agent), have carefully read this Waiver and Consent, fully understand its terms, and sign it freely and voluntarily.

I acknowledge that by signing, I and the registered minors have waived significant rights and agree to be bound by the terms of this Waiver and Consent for myself and on behalf of the registered minors.

I irrevocably and expressly agree that the contents of this Waiver and Consent are fair and necessary to protect PT DUE's interests. If any limitation is deemed void but could be valid by partial deletion or reduced application, the limitation shall apply as modified to be valid and enforceable.

By signing this Waiver and Consent, I hereby represent and warrant to PT DUE that I have all necessary legal authority, and have obtained all required permissions and consents, including without limitation to spousal and/or parental consent (as applicable), to enter into and execute this Waiver and Consent. This Waiver and Consent constitutes my valid and legally binding obligation, enforceable in accordance with its terms.

This Waiver and Consent is governed by and shall be interpreted in accordance with Indonesian law, and the Indonesian courts shall have exclusive jurisdiction over any disputes arising from this Waiver and Consent. If any part of this Waiver and Consent is found invalid or unenforceable under Indonesian law, the remaining provisions shall remain in full force and effect.
This Waiver and Consent is documented in both English and Bahasa Indonesia, in the event of discrepancy, the Bahasa Indonesia version shall prevail.
EOD,
