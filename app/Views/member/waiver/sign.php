...
<div class="max-w-2xl mx-auto p-6 rounded">
    <div style="height: 50vh; overflow: auto;" class="text-left">
        ...
        <!-- Checkbox Konfirmasi (sembunyi dulu) -->
        <div id="checkboxContainer" class="mb-4 space-y-2" style="display:none;">
...
<script>
    ...
    // Tampilkan checkbox saat user mulai tanda tangan
    let checkboxShown = false; // supaya hanya tampil sekali
