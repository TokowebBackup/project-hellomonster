...
<div class="max-w-md w-full mx-auto px-4 sm:px-6 py-10">
    <h2 class="font-bold text-xl mb-6 text-center sm:text-left"><?= lang('Text.create_password') ?></h2>

    <form action="/membership/save-password" method="post" class="space-y-6">
        <?= csrf_field() ?>
        ...
        <button type="submit"
            class="w-full py-2 bg-red-500 text-white rounded-md hover:bg-red-600 font-semibold">
