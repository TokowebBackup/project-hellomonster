...
class Admin extends BaseController
{
    ...
    public function notificationList()
    {
        ...
        $data['pager'] = $notifModel->pager; // simpan pager untuk view
    ...
    {
        $notificationModel = new \App\Models\NotificationModel(); // sesuaikan nama model
        $notificationModel->truncate(); // Hapus semua data

        session()->setFlashdata('success', 'All notifications have been deleted.');
        return redirect()->to(base_url('admin/notifications/list'));
    }
